	...
	\begin{proof}
		...
		\begin{align*}
			s^{-1}(z)&=\begin{cases}\newcommand{\z}{\frac{\bar z}{|z|^2}}
				...
				\end{cases}\\
				&= \cpr{\frac{1}{|z|}\frac{2\Re(\frac{\bar z}{|z|})}{|z|^{-1}+1}, \frac{1}{|z|}\frac{2\Im(\frac{\bar z}{|z|})}{|z|^{-1}+1},\frac{|z|^{-1}-1}{|z|^{-1}+1}}\Rightarrow \text{ mult by }\frac{|z|}{|z|}\\
				&= \cpr{\frac{2\Re(z)}{1+|z|}, \frac{-2\Im(\bar z)}{1+|z|},-\frac{|z|-1}{|z|+1}}\\
				&= (x_1, -x_2, -x_3)
		\end{align*}
